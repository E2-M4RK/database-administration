...
if (isset($_POST['btnDelete'])) {
  $Dlpost = $_POST['Dlpost'];
  $deleteUserInfo = "DELETE FROM userinfo WHERE userID = '$Dlpost'";
  $deleteUser = "DELETE FROM users WHERE userID = '$Dlpost'";
  executeQuery($deleteUserInfo);
      ...
      while ($userinfo = mysqli_fetch_assoc($results)) {
        ...
        <div class="card my-3 p-4 rounded-5">
          <div class="card-header"
            style="background-image: url('Images/nbaplayers.png'); height: 200px; background-size: cover;">
            <img src="Images/No profile.png" class="rounded-circle" alt="User Profile Picture"
              style="width: 150px; position: absolute; top: 150px; left: 20px;">
          </div>
          <div class="card-body pt-5" style="margin-top: 10px;">
            ...
            <div class="mt-4">
              ...
              <div class="mb-2"><strong>Username:</strong> <span class="ms-2"><?php echo $userinfo['username']; ?></span>
              </div>
              <div class="mb-2"><strong>Email:</strong> <span class="ms-2"><?php echo $userinfo['email']; ?></span></div>
              <div class="mb-2"><strong>Birth Date:</strong> <span class="ms-2"><?php echo $userinfo['birthDay']; ?></span>
              </div>
              <div class="mb-2"><strong>Phone Number:</strong> <span
                  class="ms-2"><?php echo $userinfo['phoneNumber']; ?></span></div>
              <form method="post">
                <input type="hidden" value="<?php echo $userinfo['userID']; ?>" name="Dlpost">
                <button class="btn btn-danger mt-3" name="btnDelete">Delete</button>
                <a href="view.php?userID=<?php echo $userinfo['userID']; ?>" class="btn btn-primary mt-3">Edit</a>
              </form>
            </div>
          </div>
        </div>
